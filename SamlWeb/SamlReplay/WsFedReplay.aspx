<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WsFedReplay.aspx.cs" Inherits="SamlReplay.WSFedReplay" %>
        ...
        <form id="form1" runat="server" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:TextBox ID="wctx" runat="server" CssClass="form-control" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <label for="wresult">WS-Fed Result</label>
                    <asp:TextBox ID="wresult" runat="server" TextMode="MultiLine" Width="800" Height="800" CssClass="form-control" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
